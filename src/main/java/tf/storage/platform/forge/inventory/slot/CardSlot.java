...
/**
 * A slot specifically for memory cards (TFUnit items).
...
public class CardSlot extends GenericSlot {
    ...
    public boolean mayPlace(ItemStack stack) {
        ...
        if (this.getItemHandler() instanceof IItemHandlerSelective) {
            IItemHandlerSelective selective = (IItemHandlerSelective) this.getItemHandler();
            if (!selective.isItemValidForSlot(this.getSlotIndex(), stack)) {
                return false;
            }
        }
