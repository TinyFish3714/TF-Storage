...
public class CraftingWrapper extends InventoryCrafting
{
    ...
    public CraftingWrapper(int width, int height,
            IItemHandlerModifiable craftMatrix, ResultWrapper resultInventory, EntityPlayer player, Container container)
    {
        super(container, 0, 0);
